...
for i=1:length(lambda_vec)
    ...
    % We are calc J as error not as cost. So , lambda should not be
    % included when calculating error for thetas that have been trained,
    % else it will be biased
    % Refer to 2.1 Exercise 5, error is comp w/o lambda
